    ...
    <div className="flex flex-col items-center justify-center min-h-[60vh]">
      <div className="text-center mb-8">
        ...
        <p className="text-brand-muted mt-3 text-sm">
          Access your bookings, quotes, contracts, and payments.
        </p>
      </div>
      ...
      <SignIn
        ...
        appearance={{
          elements: {
            ...
            identityPreviewEditButton: 'text-brand-accent hover:text-brand-dark',
      ...
      <p className="text-center text-sm text-brand-muted mt-6">
        ...
        <Link href="/portal/signup" className="font-bold text-brand-accent hover:text-brand-dark transition-colors">
          Create Account
        </Link>
      </p>
    </div>
