...
export default function VideoLightboxSection() {
  return (
    <section className="relative py-40 bg-fixed bg-cover bg-center border-y border-slate-800">
      ...
      <div className="absolute inset-0 bg-[linear-gradient(rgba(11,13,17,0.5)_2px,transparent_2px),_linear-gradient(90deg,rgba(11,13,17,0.5)_2px,transparent_2px)] bg-[size:30px_30px] opacity-20 -z-10"></div>

      <div className="relative z-10 max-w-3xl mx-auto px-6 text-center">
        <button
          id="playVideo"
          className="group w-24 h-24 bg-white/5 border border-white/20 backdrop-blur-md flex items-center justify-center mx-auto hover:bg-brand-accent hover:border-brand-accent transition-all duration-300 mb-12 rounded-sm"
        >
          <svg
